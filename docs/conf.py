# -*- coding: utf-8 -*-
#
# Facial Expression Recognition (ICLR2026) documentation build configuration file, created by
# sphinx-quickstart.
#
...
project = u'Facial Expression Recognition (ICLR2026)'
...
htmlhelp_basename = 'facial_expression_recognition_(iclr2026)doc'
...
latex_documents = [
    ('index',
     'facial_expression_recognition_(iclr2026).tex',
     u'Facial Expression Recognition (ICLR2026) Documentation',
     u"Abdul Hai Karimi", 'manual'),
]
...
man_pages = [
    ('index', 'facial_expression_recognition_(iclr2026)', u'Facial Expression Recognition (ICLR2026) Documentation',
     [u"Abdul Hai Karimi"], 1)
]
